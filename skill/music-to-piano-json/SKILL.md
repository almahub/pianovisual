...
- Produce three logical roles but map them to two playable hands: melody/voice to the right hand; one bass note plus one characteristic chord tone to the left hand.
...
- Keep the left hand deliberately easy: no more than two simultaneous notes, never wider than one octave, one harmonic attack per stabilized chord, and economical movement between chord tones. Exclude the declared bass pitch class from the upper note when another chord tone is available.
